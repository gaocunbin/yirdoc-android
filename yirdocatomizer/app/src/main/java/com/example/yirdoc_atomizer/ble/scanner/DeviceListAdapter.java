	...
	public View getView(int position, View oldView, ViewGroup parent) {
		...
		default:
			if (view == null) {
				...
				holder.rssi_value = (TextView) view.findViewById(R.id.rssi_value);
				view.setTag(holder);
			}
			...
			if (!device.isBonded || device.rssi != ScannerFragment.NO_RSSI) {
				...
				holder.rssi_value.setText(String.valueOf(device.rssi)+"db");
				holder.rssi_value.setVisibility(View.GONE);
			} else {
